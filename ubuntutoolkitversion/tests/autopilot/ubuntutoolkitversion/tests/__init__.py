...
class BaseTestCase(AutopilotTestCase):
    ...
    click_package = '{0}.{1}'.format('ubuntutoolkitversion', 'liu-xiao-guo')

    def setUp(self):
        super(BaseTestCase, self).setUp()
        self.launcher, self.test_type = self.get_launcher_and_type()
        self.app = ubuntutoolkitversion.TouchApp(self.launcher(), self.test_type)
