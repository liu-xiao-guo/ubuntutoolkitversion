...
UBUNTU_TRANSLATION_DOMAIN="ubuntutoolkitversion.liu-xiao-guo"
...
aptest.commands = bash $$PWD/ubuntutoolkitversion/tests/autopilot/run
aptest.depends  = sub-ubuntutoolkitversion

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/ubuntutoolkitversion/tests/unit
unittest.depends  = sub-ubuntutoolkitversion
